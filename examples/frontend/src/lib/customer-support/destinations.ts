import tokyoImageDataUrl from "../../assets/customer-support/tokyo.png?inline";
import santoriniImageDataUrl from "../../assets/customer-support/santorini.png?inline";
import parisImageDataUrl from "../../assets/customer-support/paris.png?inline";
