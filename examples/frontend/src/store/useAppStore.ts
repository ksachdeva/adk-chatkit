...
import { CAT_STATE_API_URL, THEME_STORAGE_KEY } from "../lib/cat/config";
import type { CatSpeechPayload, CatStatePayload } from "../lib/cat/cat";
...
export const useAppStore = create<AppState>((set, get) => {
  ...
  return {
    ...
    speech: null,
    setSpeech: (payload) => {
      const speechPayload: SpeechState = payload ? { ...payload, id: Date.now() } : null;
